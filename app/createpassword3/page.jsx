  ...
  return (
    <div className="border-black border-2 items-center justify-center h-full p-4 px-4 mx-4 py-4 flex flex-col ">
      ...
      <div className="text-xl text-center font-bold mb-4 mt-8">
        <Image alt="" src={create} className="mx-auto" />
      </div>
      <div className="flex justify-between mb-8 max-w-lg ">
        <div className="flex items-center flex-col">
          <Image
            alt=""
            src={lockpassword}
            className="rounded-full bg-[#D0F500] border-black border-2 h-16 w-16 p-3"
          />
          <p className="text-sm font-semibold pt-3">Create Password</p>
        </div>
        ...
        <div className="flex items-center flex-col">
          <Image
            alt=""
            src={lock}
            className="rounded-full border-gray-300 border-2 h-16 w-16 p-3 "
          />
          <p className="text-sm font-semibold text-gray-400 pt-3">
            Secure Wallet
          </p>
      ...
      <form onSubmit={handleCreatePassword} className="mx-4">
        <div className="my-4">
          ...
          <input
            ...
            value={password}
            onChange={handlePasswordChange}
            className={`shadow appearance-none w-full py-3 px-4 text-gray-700 leading-tight ${newPasswordBorder}`}
          />
        </div>
        ...
        <div className="mb-4 mt-8">
          ...
          <input
            ...
            value={confirmPassword}
            onChange={handleConfirmPasswordChange}
            className={`shadow appearance-none w-full py-3 px-4 text-gray-700 leading-tight border ${confirmPasswordBorder}`}
          />
        </div>
        {passwordError && <p className="text-red-500">{passwordError}</p>}
        {/* Terms of Use */}
