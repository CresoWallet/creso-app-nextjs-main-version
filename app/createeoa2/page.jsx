...
export default function CreateEoaWalletPage() {
  ...
  return (
    <div className="border-black border-2 items-center justify-center h-full p-4 px-4 mx-4 py-4 flex flex-col ">
      ...
      <ul className="w-full max-w-lg mx-auto my-8 font-bold">
      ...
      <div className="text-gray-500 mx-auto mb-8 max-w-lg">
        <p className="mt-8">
        ...
        <p className="mt-4">
          ...
          information on our privacy practices in general, see our Privacy
          <span className="text-[#FF4085] ml-1">Policy here.</span>
        </p>
      </div>
      ...
      <div className="flex flex-col sm:flex-row ">
        ...
        <button
          className={`rounded-full py-4 px-14 mx-2 mb-2 border-black ${
