...
//   const [isSmallScreen, setIsSmallScreen] = useState(false);
//   const [userInfo, setUserInfo] = useState(null);
//   const [updatedInfo, setUpdatedInfo] = useState({}); // State to store updated user information
...
//       const res = await updateUserInformationApi(updatedInfo);
//       if (res.success) {
//         // Handle success
//         console.log("User information updated successfully");
//         // You might want to update local state with the updated user information here
//       } else {
//         // Handle failure
...
//   // Function to update the updatedInfo state when user changes input fields
